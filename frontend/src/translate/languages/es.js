  ...
  es: {
    translations: {
      ...
      about: {
        ...
        buttonclose: "Cerrar",
        title: "Acerca de Chat CRM",
        abouttitle: "Origen y Mejoras",
        aboutdetail:
          "El Chat CRM es derivado indirecto del proyecto Whaticket con mejoras compartidas por los desarrolladores del sistema EquipeChat a través del canal VemFazer en YouTube, posteriormente mejorado por Claudemir Todo Bom.",
        ...
        licensedetail:
          "El Chat CRM está licenciado bajo la Licencia Pública General Affero de GNU versión 3, lo que significa que cualquier usuario que tenga acceso a esta aplicación tiene derecho a obtener acceso al código fuente. Más información en los siguientes enlaces:",
        licensefulltext: "Texto completo de la licencia",
        licensesourcecode: "Código fuente de Chat CRM"
      },
      schedules: {
        title: "Agendamentos",
        confirmationModal: {
      ...
      wavoipModal: {
        ...
        coupon:
          "¡Al contratar el servicio use el cupón Chat CRM para ganar un descuento!"
      },
      openHours: {
      ...
      chatCRM: {
        registration: {
          header: "Regístrate en la base de usuarios de Chat CRM",
          description:
            "Complete los campos a continuación para registrarse en la base de usuarios de Chat CRM y recibir noticias sobre el proyecto.",
          name: "Nombre",
          country: "País",
        ...
        support: {
          title: "Apoyar el proyecto Chat CRM",

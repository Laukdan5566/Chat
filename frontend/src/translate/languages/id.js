const messages = {
  id: {
    translations: {
      ...
      about: {
        aboutthe: "Tentang",
        copyright: "� 2024 - Didukung oleh Chat CRM",
        buttonclose: "Tutup",
        title: "Tentang Chat CRM",
        abouttitle: "Asal dan peningkatan",
        aboutdetail:
          "Chat CRM berasal secara tidak langsung dari proyek Whaticket dengan peningkatan yang dibagikan oleh para pengembang sistem EquipeChat melalui saluran VemFazer di YouTube, kemudian ditingkatkan oleh Claudemir Todo Bom",
        ...
        licensedetail:
          "Chat CRM dilisensikan di bawah GNU Affero General Public License versi 3, yang berarti bahwa setiap pengguna yang memiliki akses ke aplikasi ini berhak untuk mendapatkan akses ke kode sumbernya. Informasi lebih lanjut di tautan berikut:",
        licensefulltext: "Teks lengkap lisensi",
        licensesourcecode: "Kode sumber Chat CRM"
      },
      schedules: {
        title: "Jadwal",
        confirmationModal: {
      ...
      chatCRM: {
        registration: {
          header: "Daftar di basis pengguna Chat CRM",
          description:
            "Isi kolom di bawah ini untuk mendaftar di basis pengguna Chat CRM dan menerima berita tentang proyek.",
          name: "Nama",
          country: "Negara",

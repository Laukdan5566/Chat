  ...
  pt_PT: {
    translations: {
      ...
      about: {
        ...
        licensedetail:
          "O Chat CRM está licenciado sob a GNU Affero General Public License versão 3, isso significa que qualquer utilizador que tiver acesso a esta aplicação tem o direito de obter acesso ao código fonte. Mais informações nos links abaixo:",
      ...
      chatCRM: {
        registration: {
          header: "Registe-se na base de utilizadores do Chat CRM",
          description:
            "Preencha os campos abaixo para se registar na base de utilizadores do Chat CRM e receber novidades sobre o projeto.",
          name: "Nome",
          country: "País",

  ...
  pt: {
    translations: {
      ...
      connections: {
        ...
        toolTips: {
          ...
          passkey: {
            ...
            content:
              "O WhatsApp solicitou captura de sessão pelo navegador. Abra o assistente para continuar."
          },
          resetPasskey: "Resetar sessão",
      ...
      qrCode: {
        ...
        startCapture: "Capturar sessão",
        installExtension: "Instalar captura"
      },
      passkeyModal: {
        title: "Captura de sessão WhatsApp",
        instructions:
          "Quando o WhatsApp exigir autenticação adicional, use a extensão de captura para importar a sessão do WhatsApp Web.",
        connectorNotFound:
          "Extensão de captura não detectada neste navegador.",
        downloadExtension: "Baixar extensão",
        instructionsIntro:
          "Instale a extensão no navegador e deixe o WhatsApp Web aberto na conta desejada.",
        installStep1: "Baixe a extensão.",
        installStep2: "Abra a tela de extensões do navegador.",
        installStep3: "Ative o modo de desenvolvedor.",
        installStep4: "Carregue a extensão descompactada.",
        installStep5: "Abra o WhatsApp Web no mesmo navegador.",
        installStep6: "Confirme que a conta correta está aberta.",
        installStep7: "Volte para esta tela.",
        installStep8: "Clique em iniciar captura.",
        connectorReady: "Extensão detectada.",
        startCapture: "Iniciar captura",
        waitingForCapture: "Aguardando captura da sessão...",
        existingSession: "Sessão atual detectada para {{number}}.",
        captureExisting: "Capturar sessão atual",
        clearAndContinue: "Limpar e continuar",
        importSent: "Sessão enviada para o servidor.",
        importError: "Falha ao importar sessão: {{reason}}",
        missingToken: "Token de captura indisponível."
      },
      contacts: {
        title: "Contatos",
        toasts: {
      ...
      contactModal: {
        ...
        form: {
          ...
          preferredQueue: "Consultora responsável",
          noPreferredQueue: "Não vinculado"
        },
        buttons: {

  ...
  en: {
    translations: {
      ...
      connections: {
        ...
        toolTips: {
          ...
          passkey: {
            ...
            content:
              "WhatsApp requested browser session capture. Open the assistant to continue."
          },
          resetPasskey: "Reset session",
          refresh: "Refresh",
          disconnect: "Disconnect",
          scan: "Scan QR Code",
      ...
      qrCode: {
        ...
        startCapture: "Capture session",
        installExtension: "Install capture"
      },
      passkeyModal: {
        title: "WhatsApp session capture",
        instructions:
          "When WhatsApp requires additional authentication, use the capture extension to import the WhatsApp Web session.",
        connectorNotFound: "Capture extension was not detected in this browser.",
        downloadExtension: "Download extension",
        instructionsIntro:
          "Install the extension in the browser and keep WhatsApp Web open in the desired account.",
        installStep1: "Download the extension.",
        installStep2: "Open the browser extensions page.",
        installStep3: "Enable developer mode.",
        installStep4: "Load the unpacked extension.",
        installStep5: "Open WhatsApp Web in the same browser.",
        installStep6: "Confirm the correct account is open.",
        installStep7: "Return to this screen.",
        installStep8: "Click start capture.",
        connectorReady: "Extension detected.",
        startCapture: "Start capture",
        waitingForCapture: "Waiting for session capture...",
        existingSession: "Current session detected for {{number}}.",
        captureExisting: "Capture current session",
        clearAndContinue: "Clear and continue",
        importSent: "Session sent to the server.",
        importError: "Failed to import session: {{reason}}",
        missingToken: "Capture token unavailable."
      },
      contacts: {
        title: "Contacts",
        toasts: {
      ...
      about: {
        aboutthe: "About the",
        copyright: "© 2024 - Powered by Chat CRM",
        buttonclose: "Close",
        title: "About Chat CRM",
        abouttitle: "Origin and improvements",
        aboutdetail:
          "Chat CRM is indirectly derived from the Whaticket project with improvements shared by the developers of the EquipeChat system through the VemFazer channel on YouTube, later improved by Claudemir Todo Bom",
        ...
        licensedetail:
          "Chat CRM is licensed under the GNU Affero General Public License version 3, which means that any user who has access to this application has the right to obtain access to the source code. More information at the links below:",
        licensefulltext: "Full text of the license",
        licensesourcecode: "Chat CRM source code"
      },
      schedules: {
        title: "Schedules",
        confirmationModal: {
      ...
      wavoipModal: {
        ...
        coupon:
          "When hiring the service use the coupon Chat CRM to get a discount!"
      },
      openHours: {
      ...
      chatCRM: {
        registration: {
          header: "Register in the Chat CRM user base",
          description:
            "Fill in the fields below to register in the Chat CRM user base and receive news about the project.",
          name: "Name",
          country: "Country",
        ...
        support: {
          title: "Support Chat CRM project",

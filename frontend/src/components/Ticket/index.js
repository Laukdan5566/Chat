...
const Ticket = () => {
  ...
  const renderMessagesList = () => {
    ...
    const canSendMessage =
      ...
      (isParticipant &&
        hasUserPermission(user, "ticket-participants:sendMessage"));
    ...
    return (
      <>
        ...
        {canSendMessage ? (
          ...
          <Paper className={classes.participantReadOnly} square>
            <Typography variant="body2" color="textSecondary">
              Você está participando como apoio. Use anotação interna para
              registrar contexto sem enviar mensagem ao cliente.
            </Typography>
          </Paper>
        )}
      </>

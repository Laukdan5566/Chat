...
const QueueSchema = Yup.object().shape({
  ...
  n8nWebhookUrl: Yup.string().when("n8nWebhookEnabled", {
    is: true,
    then: schema =>
      schema
        .url("Informe uma URL valida")
        .required("Informe a URL do webhook do n8n"),
                      ...
                      <Field name="n8nWebhookEnabled">
                        {({ field, form }) => (
                          <FormControlLabel
                            ...
                            label="Enviar mensagens desta fila para o n8n"
                          />
                        )}
                      </Field>
                      <Field
                        as={TextField}
                        label="URL do webhook do n8n"
                        name="n8nWebhookUrl"
                        type="url"
                        fullWidth
                        disabled={!values.n8nWebhookEnabled}
                        error={
                          touched.n8nWebhookUrl &&
                          Boolean(errors.n8nWebhookUrl)
                        }
                        helperText={
                          touched.n8nWebhookUrl && errors.n8nWebhookUrl
                            ? errors.n8nWebhookUrl
                            : "Use a URL de producao/teste do webhook que recebe a mensagem."
                        }
                        variant="outlined"
                        margin="dense"

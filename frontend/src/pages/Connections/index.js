...
const Connections = () => {
  ...
  const canAddConnection = hasUserPermission(
    user,
    "connections-page:addConnection"
  );
  const canEditConnection = hasUserPermission(
    user,
    "connections-page:editOrDeleteConnection"
  );
  const canUseSessionActions = hasUserPermission(
    user,
  ...
  const renderActionButtons = whatsApp => {
    ...
    return (
      <>
        {canUseSessionActions && whatsApp.status === "qrcode" && (
        ...
        {canUseSessionActions && whatsApp.status === "passkey_required" && (
          <>
        ...
        {canUseSessionActions && canRetrySession && (
          <>
  ...
  return (
    <MainContainer>
      ...
      <QrcodeModal
        ...
        onOpenPasskeyModal={handleTriggerCaptureFromQr}
                  ...
                  whatsApps.map(whatsApp => (
                    <TableRow key={whatsApp.id}>
                      ...
                      <TableCell align="center">
                        ...
                        {canEditConnection && whatsApp.status === "CONNECTED" && (
                          <IconButton
                            size="small"

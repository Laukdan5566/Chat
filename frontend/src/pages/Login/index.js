  ...
  backgroundLayer: {
    ...
    background:
      theme.palette.type === "light"
        ? `linear-gradient(135deg, #f8fafc 0%, #eef6fb 42%, ${theme.palette.primary.main} 100%)`
        : `linear-gradient(135deg, #070b12 0%, #101820 46%, ${theme.palette.primary.main} 100%)`,
    ...
    "&::after": {
      ...
      background:
        theme.palette.type === "light"
          ...
          : "linear-gradient(90deg, rgba(7,11,18,0.72), rgba(7,11,18,0.36))"
    },
              ...
              <div className={classes.formCardWrap}>
                <div className={classes.paper}>
                  ...
                  >
                    ...
                    >
                      <MenuItem value="keep">
                        Entrar sem derrubar logins ativos
                      </MenuItem>
                      <MenuItem value="replaceLast">
                        Derrubar ultimo login deste dispositivo
                      </MenuItem>
                      <MenuItem value="replaceAll">
                        Derrubar todos os logins ativos
                      </MenuItem>
                    </TextField>
                    <Button
                      type="submit"

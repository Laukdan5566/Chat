...
const UpdateContactService = async ({
  ...
  let normalizedPreferredQueueId: number | null = null;

  if (
    preferredQueueId !== undefined &&
    preferredQueueId !== null &&
    preferredQueueId !== ""
  ) {
    const queueId = Number(preferredQueueId);
    ...
    normalizedPreferredQueueId = queueId;
  }
  ...
  try {
    await contact.update({
      ...
      language,
      ...(preferredQueueId !== undefined
        ? { preferredQueueId: normalizedPreferredQueueId }
        : {})
    });
  } catch (e) {
